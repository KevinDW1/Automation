...
def test_job01(shared_page): _safe_run(job01, shared_page)
def test_job02(shared_page): _safe_run(job02, shared_page)
def test_job03(shared_page): _safe_run(job03, shared_page)
def test_job04(shared_page): _safe_run(job04, shared_page)
def test_job05(shared_page): _safe_run(job05, shared_page)
def test_job06(shared_page): _safe_run(job06, shared_page)
def test_job07(shared_page): _safe_run(job07, shared_page)
def test_job08(shared_page): _safe_run(job08, shared_page)
def test_job09(shared_page): _safe_run(job09, shared_page)
def test_job10(shared_page): _safe_run(job10, shared_page)
def test_job11(shared_page): _safe_run(job11, shared_page)
def test_job12(shared_page): _safe_run(job12, shared_page)
def test_job13(shared_page): _safe_run(job13, shared_page)
def test_job14(shared_page): _safe_run(job14, shared_page)
def test_job15(shared_page): _safe_run(job15, shared_page)
def test_job16(shared_page): _safe_run(job16, shared_page)
def test_job17(shared_page): _safe_run(job17, shared_page)
def test_job18(shared_page): _safe_run(job18, shared_page)
def test_job19(shared_page): _safe_run(job19, shared_page)
def test_job20(shared_page): _safe_run(job20, shared_page)
def test_job21(shared_page): _safe_run(job21, shared_page)
def test_job22(shared_page): _safe_run(job22, shared_page)
def test_job23(shared_page): _safe_run(job23, shared_page)
def test_job24(shared_page): _safe_run(job24, shared_page)
